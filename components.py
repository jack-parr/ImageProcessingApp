...
class TreeStage(pyqtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.titleBox.setFixedSize(int(config.TREE_PANEL_WIDTH - config.TREE_MOVE_BTN_WIDTH - 2*(config.TREE_STAGE_HEIGHT / 2)), int(config.TREE_STAGE_HEIGHT / 2))
        ...
        self.hideButton = pyqtWidgets.QPushButton('G')
        self.hideButton.setFixedSize(int(config.TREE_STAGE_HEIGHT / 2), int(config.TREE_STAGE_HEIGHT / 2))
        ...
        self.topPanelLayout.addWidget(self.hideButton)
